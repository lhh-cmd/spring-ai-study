...
function actionText(action) {
    const map = {
        ...
        RESOLVE_CONFLICT: '解决冲突', NEXT_ENV: '进入下一环境', EXIT_INTEGRATION: '退出集成',
        CR_PASS: 'CR通过', CR_REJECT: 'CR驳回', REJECT_MERGE: '驳回合并', PUBLISH: '发布',
        MERGE_MASTER: '合并master', RESET_ENV: '环境重置'
    };
